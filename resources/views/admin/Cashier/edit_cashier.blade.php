...
@section('content-title', 'Edit ' . $cashier->username . ' Cashier')
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                          action="{{ route('admin.cashier.update', $cashier->user_id) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="item form-group">
                            <div class="col-md-8 col-sm-8 offset-md-2">
                                <input type="text" name="name" class="form-control has-feedback-left"
                                       placeholder="Full Name" value="{{ old('name', $cashier->name) }}" required>
                        ...
                        <div class="item form-group">
                            <div class="col-md-8 col-sm-8 offset-md-2">
                                <input type="tel" name="phone" class="form-control has-feedback-left"
                                       placeholder="ex. 09809879797" value="{{ old('phone', $cashier->phone) }}">
                        ...
                        <div class="item form-group">
                            <div class="col-md-8 col-sm-8 offset-md-2">
                                <input type="email" name="email" class="form-control has-feedback-left"
                                       placeholder="ex. supplier@gmail.com" value="{{ old('email', $cashier->email) }}" required>
                        ...
                        <div class="item form-group">
                            <div class="col-md-8 col-sm-8 offset-md-2">
                                <input type="text" name="username" class="form-control has-feedback-left"
                                       placeholder="Username" value="{{ old('username', $cashier->username) }}" required>
                                <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                            </div>
                            @error('username')
                            <div class="text-danger font-weight-bold">
