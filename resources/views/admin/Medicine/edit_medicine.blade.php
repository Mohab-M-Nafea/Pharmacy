...
@section('content-title', "Edit $medicine->medicine_name Medicine")
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                          action="{{ route('admin.medicine.update', $medicine->medicine_id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                                ...
                                <select name="category" class="form-control" required>
                                    ...
                                    @foreach($categories as $category)
                                        <option
                                            ...
                                            @if(old('category', $medicine->category_id) === $category->category_id) selected @endif
                                        >
                                ...
                                <select name="supplier" class="form-control" required>
                                    ...
                                    @foreach($suppliers as $supplier)
                                        <option
                                            ...
                                            @if(old('supplier', $medicine->supplier_id) === $supplier->supplier_id) selected @endif
                                        >
                            ...
                            <div class="col-md-12 col-sm-12">
                                <textarea name="medicine_description" class="form-control"
                                          ...
                                          required>{{ old('medicine_description', $medicine->medicine_description) }}</textarea>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <input type="text" name="medicine_generic_name" class="form-control has-feedback-left"
                                       ...
                                       value="{{ old('medicine_generic_name', $medicine->medicine_generic_name) }}">
                                <span class="fa fa-medkit form-control-feedback left" aria-hidden="true"></span>
                            </div>
                            <div class="col-md-4 col-sm-4">
                                <input type="text" name="medicine_purchase_price" class="form-control has-feedback-left"
                                       placeholder="Purchase Price"
                                       value="{{ old('medicine_purchase_price', $medicine->medicine_purchase_price) }}"
                                       required>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <input type="text" name="medicine_retail_price" class="form-control has-feedback-left"
                                       ...
                                       value="{{ old('medicine_retail_price', $medicine->medicine_retail_price) }}"
                                       required>
                                <span class="fa fa-dollar form-control-feedback left" aria-hidden="true"></span>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <input type="text" name="medicine_quantity" class="form-control has-feedback-left"
                                       ...
                                       value="{{ old('medicine_quantity', $medicine->medicine_quantity) }}" required>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <input type="text" name="medicine_unit" class="form-control has-feedback-left"
                                       placeholder="Unit" value="{{ old('medicine_unit', $medicine->medicine_unit) }}"
                                       required>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <input type="date" name="medicine_expired_date" class="form-control has-feedback-left"
                                       placeholder=""
                                       value="{{ old('medicine_expired_date', $medicine->medicine_expired_date) }}"
                                       required>
